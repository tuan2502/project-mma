        ...
        <View style={{ flex: 1 }}>
          ...
          <View style={{ flex: 1, backgroundColor: "#f5f5f5" }}>
            <View style={{ justifyContent: "center", alignItems: "center" }}>
              <Image
                source={{
                  uri: `${information?.image ?? "https://images.unsplash.com/photo-1589656966895-2f33e7653819?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80"}`,
                }}
                style={{
                  width: 100,
                  height: 100,
            ...
            <View style={{ marginTop: 60 }}>
              ...
              <View style={{ marginLeft: 50, marginRight: 50 }}>
                ...
                >
                  ...
                  >
                    <Text style={{ fontWeight: "bold" }}>{information.phone}</Text>
                  </View>
                </View>
                <View
                  style={{
                ...
                >
                  ...
                  >
                    <Text style={{ fontWeight: "bold" }}>{information.address}</Text>
                  </View>
                </View>
                <View
                  style={{
